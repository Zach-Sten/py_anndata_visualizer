 ...
 * dispatcher.js
 * 
 * Moves queued iframe clicks into the correct hidden widget bridge + triggers poll button.
 * This script runs in the parent window and bridges iframe requests to Python callbacks.
 * 
